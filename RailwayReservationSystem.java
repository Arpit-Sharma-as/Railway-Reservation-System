...
public class RailwayReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        while (isRunning) {
            ...
            System.out.println("2. Display All The Ticket Information");
    ...
    public static void bookTicket() {
        ...
        System.out.println("1. Pune-Hyderabad (Train Number: 1010)");
        System.out.println("2. Delhi-Jammu (Train Number: 2013)");
        System.out.println("3. Punjab-Mumbai (Train Number: 3045)");
